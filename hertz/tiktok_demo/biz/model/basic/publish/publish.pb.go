...
type DouyinPublishActionRequest struct {
	...
	Data  []byte `protobuf:"bytes,2,opt,name=data,proto3" form:"data" json:"data,omitempty" query:"data"`     // video data
	Title string `protobuf:"bytes,3,opt,name=title,proto3" form:"title" json:"title,omitempty" query:"title"` // video title
}
...
type DouyinPublishListResponse struct {
	...
	StatusCode int32           `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" form:"status_code" json:"status_code" query:"status_code"`
	StatusMsg  string          `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	VideoList  []*common.Video `protobuf:"bytes,3,rep,name=video_list,json=videoList,proto3" form:"video_list" json:"video_list,omitempty" query:"video_list"` // list of videos posted by users
}
...
var file_publish_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x42, 0x43, 0x5a, 0x41, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6e, 0x6a, 0x75, 0x70, 0x74, 0x2d,
	0x73, 0x61, 0x6b, 0x75, 0x72, 0x61, 0x2f, 0x68, 0x65, 0x72, 0x74, 0x7a, 0x2f, 0x74, 0x69, 0x6b,
	0x74, 0x6f, 0x6b, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2f, 0x62, 0x61, 0x73, 0x69, 0x63, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
