...
import (
	_ "github.com/njupt-sakura/hertz/tiktok_demo/biz/model/api"
	common "github.com/njupt-sakura/hertz/tiktok_demo/biz/model/common"
...
type DouyinRelationActionRequest struct {
	...
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" form:"action_type" json:"action_type,omitempty" query:"action_type"` // 1-Follow, 2-Unfollow
}
...
type DouyinRelationFriendListResponse struct {
	...
	StatusCode int32         `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" form:"status_code" json:"status_code" query:"status_code"`
	StatusMsg  string        `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	UserList   []*FriendUser `protobuf:"bytes,3,rep,name=user_list,json=userList,proto3" form:"user_list" json:"user_list,omitempty" query:"user_list"`
}
...
type FriendUser struct {
	...
	Message string `protobuf:"bytes,2,opt,name=message,proto3" form:"message" json:"message,omitempty" query:"message"`  // latest chat messages with this friend
	MsgType int64  `protobuf:"varint,3,opt,name=msgType,proto3" form:"msgType" json:"msgType,omitempty" query:"msgType"` // message type，0 - Messages currently requested by the user，1 - Messages sent by the current requesting user
}
...
var file_relation_proto_rawDesc = []byte{
	...
	0x6e, 0x2f, 0x66, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x42, 0x45,
	0x5a, 0x43, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6e, 0x6a, 0x75,
	0x70, 0x74, 0x2d, 0x73, 0x61, 0x6b, 0x75, 0x72, 0x61, 0x2f, 0x68, 0x65, 0x72, 0x74, 0x7a, 0x2f,
